            ...
            services.AddSwaggerGen(
                options =>
                {
                    options.SwaggerDoc(
                        ...
                        {
                            Version = "v1",
                            Title = "Pet Clinic CQRS Rest (.NET) API"
                        });
        ...
        public static void UseSwashbuckle(this IApplicationBuilder app, IConfiguration configuration)
        {
            ...
            app.UseSwaggerUI(
                options =>
                {
                    ...
                    options.SwaggerEndpoint("/swagger/v1/swagger.json", "Pet Clinic CQRS Rest (.NET) API V1");
                    options.OAuthAppName("Pet Clinic CQRS Rest (.NET) API");
